...
function createHero() {
  ...
  heroDish.src =
    "img/menu-img/11zon_cropped (5).png"; /*прописать путь к изоьражению*/
...
const dishes = [
  {
    name: "Салат из томатов",
    price: 700,
    img: "img/menu-img/11zon_cropped (5).png",
  } /*прописать путь к изоьражению*/,
  {
...
const drinks = [
  {
    name: "Эспрессо-грей",
    price: 300,
    img: "img/drinks img/11zon_cropped (14).png",
  } /*прописать путь к изоьражению*/,
  {
    name: "Груша-drink",
    price: 350,
    img: "img/drinks img/11zon_cropped (19).png",
  } /*прописать путь к изоьражению*/,
  {
    name: "Зимняя вишня",
    price: 400,
    img: "img/drinks img/11zon_cropped (16).png",
  } /*прописать путь к изоьражению*/,
  {
    name: "Корица-ice",
    price: 380,
    img: "img/drinks img/11zon_cropped (17).png",
  } /*прописать путь к изоьражению*/,
  {
    name: "Ice-Американо",
    price: 350,
    img: "img/drinks img/11zon_cropped (18).png",
  } /*прописать путь к изоьражению*/,
  {
    name: "Зимний цитрус",
    price: 350,
    img: "img/drinks img/11zon_cropped (15).png",
  } /*прописать путь к изоьражению*/,
];
...
const drinkCarouselContainer = document.getElementById(
...
function createStarsInZones(count) {
  ...
  const drinkRect = document
    .getElementById("drink-carousel-section")
    .getBoundingClientRect();
